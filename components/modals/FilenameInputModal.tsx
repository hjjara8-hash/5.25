...
const FilenameInputModal: React.FC<FilenameInputModalProps> = memo(({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-6 rounded-lg shadow-2xl w-full sm:max-w-md max-h-[90vh] flex flex-col text-gray-900 dark:text-gray-200"
