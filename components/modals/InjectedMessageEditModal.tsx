...
const InjectedMessageEditModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-6 rounded-lg shadow-2xl w-full max-w-2xl flex flex-col relative transition text-gray-900 dark:text-gray-200 ${isDragging ? 'ring-2 ring-emerald-500 bg-gray-50 dark:bg-black/40' : ''}`}
