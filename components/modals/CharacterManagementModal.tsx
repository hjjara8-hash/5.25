...
const CharacterManagementModal: React.FC = memo(() => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex justify-center items-center p-4" onClick={closeCharacterManagementModal}>
      <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-6 rounded-lg shadow-2xl w-full sm:max-w-lg max-h-[90vh] flex flex-col text-gray-200 overflow-hidden" onClick={(e) => e.stopPropagation()}>
