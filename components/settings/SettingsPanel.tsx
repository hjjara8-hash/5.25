    ...
    return (
        <>
            <div className="fixed inset-0 bg-black/80 z-40 flex justify-center items-center p-4" onClick={closeSettingsPanel}>
                <div 
                    className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-0 rounded-2xl shadow-2xl w-full sm:max-w-lg max-h-[90vh] flex flex-col text-gray-900 dark:text-gray-200 relative overflow-hidden min-w-0" 
