...
const ChatAttachmentsModal: React.FC<ChatAttachmentsModalProps> = memo(({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-zinc-900 p-0 rounded-2xl shadow-xl w-full sm:max-w-2xl max-h-[90vh] flex flex-col text-gray-800 dark:text-gray-200 relative overflow-hidden border border-gray-200 dark:border-white/10"
