...
const PromptButtonsBar: React.FC<PromptButtonsBarProps> = memo(({ 
    ...
    return (
        <div className="flex items-center px-3 py-2 bg-gray-50 dark:bg-black/20 border-b border-gray-200 dark:border-white/5 gap-2 overflow-x-auto hide-scrollbar rounded-t-2xl">
            {showSwitchButton && onSwitchToolbar && (
                <Button
                    onClick={onSwitchToolbar}
                    variant="ghost"
                    size="none"
                    className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-white/10 transition-colors flex-shrink-0 mr-1"
                    title={t.characters}
                >
            ...
            <Button 
                ...
                variant="ghost"
                size="none"
                className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-white/10 transition-colors flex-shrink-0"
