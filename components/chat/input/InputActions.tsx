                    ...
                    <div className="flex items-center gap-1">
                        {showContinueFlow && (
                            <Button 
                                ...
                                disabled={isLoading || isFileProcessing || isAutoSendingActive || isSelectionModeActive} 
                                variant="ghost"
                                size="icon"
                                className="text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-500/10 rounded-xl transition-colors disabled:opacity-30" 
