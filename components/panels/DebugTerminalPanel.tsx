...
const DebugTerminalPanel: React.FC = memo(() => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex justify-center items-center p-4" onClick={closeDebugTerminal}>
      <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-0 rounded-xl shadow-2xl w-full sm:max-w-2xl max-h-[90vh] flex flex-col text-gray-900 dark:text-gray-100" onClick={(e) => e.stopPropagation()}>
